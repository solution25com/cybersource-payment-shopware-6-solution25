...
class CyberSourceController extends AbstractController
{
    ...
    /**
     * @Route(
     *     "/api/cybersource/order/{orderId}/capture/{cybersourceTransactionId}",
    ...
    /**
     * @Route(
     *     "/api/cybersource/order/{orderId}/refund/{cybersourceTransactionId}",
